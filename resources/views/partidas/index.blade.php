...
<form action="{{ route('partidas.search') }}" method="POST" class="flex gap-2 mb-6">
    ...
    <a href="{{ route('partidas.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400">
        Limpar
    </a>
</form>
...
<div class="overflow-x-auto">
    <table class="w-full bg-white rounded shadow text-sm">
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="7" class="text-center py-6 text-gray-500">Nenhuma partida encontrada.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
